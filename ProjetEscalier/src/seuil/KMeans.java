...
//code trouvé sur le lien suivant https://github.com/nikhitareddy/Image-Segmentation
//Modification pour l'entrée des paramètres
//et pour le type d'image en sortie ligne 109-110
public class KMeans {
	...
	public static void main(String[] args) {
		String src = "/Users/samymostafa/Desktop/bdd_images/escalier6.jpg";
		String dst = "/Users/samymostafa/Desktop/bdd_images/res6.jpg";
		int k = 2;
		String m ="-i";
		/*if (args.length != 4) {
			System.out.println("Usage: check arguments!!" + " image.png" + " image.png" + " 100" + " -i ");
			return;
		}
		// parse arguments
		String src = args[0];
